...
unlocked to sign the Eurobit-Qt.app bundle.
...
allowing somebody to distribute a Eurobit-Qt.app or eurobit-qt-setup.exe with a valid
...
that the eurobit-qt.exe file inside the installer had not been tampered with.
