...
#ifndef H_EUROBIT_SCRIPT
#define H_EUROBIT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEurobitAddress
 */
...
public:
    ...
    // Pre-version-0.6, Eurobit always counted CHECKMULTISIGs
